...
export default function Industries() {
  return (
    <section className="py-20 text-black bg-white relative overflow-hidden animate-fade-in-up">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Aerospace */}
          <div
            className="group relative overflow-hidden rounded-xl h-80 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-xl hover:shadow-primary/20 bg-white"
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-white/90 via-white/60 to-white/0 z-10"></div>
            <div className="absolute inset-x-0 bottom-0 p-6 z-30 transform transition-transform duration-500 translate-y-2 group-hover:translate-y-0">
              <div className="bg-white/90 backdrop-blur-sm p-4 rounded-lg border border-primary/20 shadow-lg">
                ...
                <p className="text-black text-sm font-['NeueMontreal']">
