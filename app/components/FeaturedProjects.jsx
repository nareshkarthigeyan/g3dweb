    ...
    <section className="py-20 bg-white relative overflow-hidden animate-fade-in-up">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white border border-orange-100 rounded-2xl shadow-xl p-8 flex flex-col items-center text-center transition-all duration-300 hover:border-primary hover:scale-[1.03] group animate-fade-in-up">
            <img
