            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up">
              ...
              {/* <Link href="/contact">
                <motion.button
                  ...
                  className="bg-white/10 hover:bg-white/20 border-2 border-white text-white font-bold py-4 px-10 rounded-lg text-lg shadow-lg transition duration-100 group relative overflow-hidden"
                >
